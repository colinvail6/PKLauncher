# PKLauncher for the Retail Kano Pixel Kit (ESP32 running CircuitPython)
# The launcher requires a CircuitPython install (DOIT ESP32 Devkit)
# with pixelkit, scroll_letters, scroll_numbers, and scroll_symbols installed
